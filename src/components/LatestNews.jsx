    ...
    return (
        <div className='container m-20 ml-10 mr-10 p-5 grid grid-cols-5 gap-2 w-[100%]'>
            <div className=" fav grid-rows w-[80%] h-[100%] ">
                <ul className='list-none text-right'><span className='font-bold'>AMERICAS FAVORITES</span>
                    <li>#TomBrady</li>
                    <li>#MichaelJordan</li>
                    <li>#Shaq</li>
                    <li>#TigerWoods</li>
            ...
            <div className="editor w-[80%] ">
                <ul className='list-none text-left'><span className='font-bold'>EDITORS PICK</span>
